...
public class GameData_LoadPath
{
    ...
    [Header("Boss物件")]
    public string bossAttack1;//Boss攻擊1物件
    public string bossAttack2;//Boss攻擊2物件
    public string bossAttack3;//Boss攻擊3物件
    public string bossAttack4;//Boss攻擊4物件
    ...
    private GameData_LoadPath()
    {
        ...
        //Boss物件
        bossAttack1 = "Prefab/ShootObject/Boss/Attack1";//Boss攻擊1物件
        bossAttack2 = "Prefab/ShootObject/Boss/Attack2";//Boss攻擊2物件
        bossAttack3 = "Prefab/ShootObject/Boss/Attack3";//Boss攻擊3物件
        bossAttack4 = "Prefab/ShootObject/Boss/Attack4";//Boss攻擊4物件
