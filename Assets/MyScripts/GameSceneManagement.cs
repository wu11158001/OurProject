...
public class GameSceneManagement : MonoBehaviourPunCallbacks
{
    ...
    void Start()
    {
        ...
        if (GameDataManagement.Instance.selectLevelNumber == 11)
        {
            ...
            tipTaskText = new string[] { "前往戰場\n擊破該區域據點", "擊倒城門守衛", "擊破戰場中央\n城門機關", "進入城內\n擊破所有據點", "到上方水池區\n擊破龍族水晶" };//提示任務文字
            taskText = new string[] { "前往戰場\n擊破該區域據點 :", "擊倒城門守衛 :", "擊破戰場中央\n城門機關:", "進入城內\n擊破所有據點 :", "到上方水池區\n擊破龍族水晶" };//個階段任務文字
            //各階段任務所需擊殺數
    ...
    public void OnCreatePlayerNameObject(string nickName, int id)
    {
        ...
        objectName.OnSetName(connectObject_Dictionary[id].transform, nickName, new Color(32, 92, 157), 1.85f);        
    }
    #endregion
}
